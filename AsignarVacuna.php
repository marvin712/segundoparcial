...
<head>
    ...
    <title>Asignar Vacuna</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous">
</head>
<body>
    <h1 class="bg-primary text-center text-white">Asignar Vacuna</h1>
    <div class="row">
        <div class="col-3"></div>
        <div class="col-6">
        <form action="EstudianteController.php" method="POST">
                ...
                <input type="submit" value="Asignar Vacuna" name="btnEditar" class="btn btn-primary">            
    </form>
        </div>
        <div class="col-3"></div>
    </div>
